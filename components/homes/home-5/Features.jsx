...
<h3 className="fs-7 sm:fs-6 lg:fs-5 xl:fs-4 font-semibold m-0">
  Industrial IoT: Shaping the Future of Smart Manufacturing
</h3>

              <p className="fs-7 sm:fs-6 lg:fs-5 xl:fs-4 text-opacity-70">
                The Industrial Internet of Things (IIoT) connects machines, equipment, and processes using sensors, software, and data analytics to optimize industrial operations. Unlike consumer-focused IoT, IIoT is built for harsh industrial environments, enabling automation, predictive maintenance, and smarter decision-making.</p>
            </div>
            <div
