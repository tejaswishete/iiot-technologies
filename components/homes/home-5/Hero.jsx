...
export default function Hero() {
  return (
   <div
  id="hero_header"
  className="hero-header hero-five-scene section panel overflow-hidden bg-white" // <-- Added `bg-white` here
>
        ...
        <div className="container max-w-xl">
          ...
          <div className="section-inner panel">
            ...
            <div className="row child-cols-12 justify-center lg:justify-between items-center g-6 lg:g-0">
             ...
             <div className="sm:col-8 lg:col-5 relative -top-4">  
                <div
  ...
  {/* Left: Heading Text */}
 <div className="flex-1 mt-[-1rem]"> {/* Adjust this value as needed */}
    <h1 className="h1 sm:display-5 xl:display-2 fw-bold leading-tight mb-1 xl:mb-2">
    ...
    <p className="fs-6 xl:fs-4">
      IIoT extends IoT into industrial environments, driving efficiency, automation, and intelligent operations.
              ...
              <div className="sm:col-auto">
                ...
                >
                 <figure className="featured-image m-0 rounded ratio ratio-1x1 rounded-3 overflow-hidden w-64 h-64">
  <Image
    className="media-cover image"
    alt="image"
    src="/assets/images/template/what-is-iiot.png"
    width="256"
    height="256"
  />
</figure>
