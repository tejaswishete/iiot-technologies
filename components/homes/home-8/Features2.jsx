...
export default function Features2() {
  return (
    ...
    >
      <div className="section-outer panel py-6 md:py-8 xl:py-10 lg:mx-2 lg:rounded-2 text-white text-opacity-70"
        ...
        <div className="container sm:max-w-lg">
          <div className="section-inner panel">
            ...
            >
              ...
              <h2 className="h2 lg:h2 m-0"
              style={{color:"#afca31"}}>
               Industrial Intelligence, Seamlessly Connected
              </h2>
              <p className="fs-6 xl:fs-5 xl:px-8">
                Delivers a unified platform for innovation, automation, and<br /> real-time operational control.
              </p>
            </div>
            <div
                  ...
                  <div className="features-item vstack items-center justify-center text-center gap-4">
                    ...
                    <div className="panel">
                      <div className="vstack gap-1">
                        <h3 className="title h6 lg:h5 m-0"
                        style = {{color:"#afca31"}}>{feature.title}</h3>
