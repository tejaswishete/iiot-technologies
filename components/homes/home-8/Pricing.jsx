  ...
  return (
    <div id="pricing" className="pricing section panel overflow-hidden">
      {/* <div className="section-outer panel py-6 xl:py-9 lg:mx-2 mt-2 lg:rounded-2 bg-secondary dark:bg-tertiary-700">
            ...
            >
              <h4
                className="h2 m-0 text-center"
                style={{ transform: "translateY(0px)", opacity: 1 , color:"#afca31"}}
              >
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px border bg-white text-dark rounded-1-5 shadow-xs">
                    <span className="icon mb-narrow">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/bar-chart.png"
                        width={40}
                        height={30}
                      />
                    </span>
                     <span className="text-xl font-extrabold mb-narrow" style={{ color: "#0a0c4c" }}>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px border bg-white text-dark rounded-1-5 shadow-xs">
                    <span className="icon mb-narrow">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/predictive.png"
                        width={50}
                        height={30}
                      />
                    </span>
                    <span className="fs-6 fw-medium mb-narrow" style={{ color: "#0a0c4c" }}>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px border bg-white text-dark rounded-1-5 shadow-xs">
                    <span className="icon mb-narrow">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/dashboard.png"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px border bg-white text-dark rounded-1-5 shadow-xs">
                    <span className="icon mb-narrow">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/network.png"
                        width={24}
                        height={24}
                      />
                    </span>
                  ...
                  <div className="vstack items-start justify-between gap-2 lg:gap-4 p-2 xl:p-3 min-h-200px border bg-white text-dark rounded-1-5 shadow-xs">
                    <span className="icon mb-narrow">
                      <Image
                        className="w-40px"
                        alt="icon"
                        src="/assets/images/custom-icons/robot.png"
                        width={24}
                        height={24}
                      />
                    </span>
          ...
          <div className="section-inner panel">
            ...
            >
              <div
                ...
                style={{ transform: "translateY(0px)", opacity: 1 }}
              >
                <span className="fs-7 fw-medium py-narrow px-2 border rounded-pill text-black">
                  Pricing
                </span>
              ...
              >
                ...
                {/*<p className="text-center mt-4 lg:mt-6 text-black">
