      ...
      <div className="section-outer panel pb-6 xl:pb-9">
        <div className="container max-w-lg">
          <div className="section-inner panel">
           <div
  className="panel vstack justify-center items-center gap-4 sm:gap-6 xl:gap-8 mt-5"
...
>
              ...
              <div
                className="row child-cols-12 sm:child-cols-6 col-match g-2 lg:g-3 uc-grid mt-2"
                data-uc-grid=""
              >
