      ...
      <div className="section-outer panel pb-6 xl:pb-9">
        <div className="container max-w-lg">
          ...
          >
            ...
            >
              {/*<h2 className="h4 sm:h3 lg:h2 mt-10 text-center">
                Frequenlty asked questions
              </h2>*/}
              <div className="panel mt-8 sm:mt-10 lg:mt-20 p-3 sm:p-4 xl:p-6 lg:max-w-750px xl:w-auto m-auto rounded-2 bg-secondary dark:bg-gray-800">
                <ul
