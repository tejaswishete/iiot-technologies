...
export default function Hero() {
  return (
    <div className="hero-header section panel overflow-hidden bg-white">
      <div className="section-outer panel py-6 xl:py-9 pt-9 lg:pt-10 bg-white">
        <div
              ...
              <div className="col-12 sm:col-9 lg:col-5">
                ...
                >
                  <span className="fs-6 fw-bold text-primary dark:text-secondary">
                    IIoT-Powered Operations
                  </span>
                  <h1 className="h2 sm:h1 lg:display-6 xl:display-5 mb-1 xl:mb-2">
                     Industry Challenges & Our IIOT Solutions
                  </h1>
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
  Industrial manufacturers today face complex challenges that affect productivity, quality, and profitability. At <strong>IIOT Technologies</strong>, we bridge these gaps with intelligent, data-driven solutions tailored for PLC-based machine environments.
</p>
                  <form
