    ...
    >
      <div className="section-outer panel">
        <div className="container max-w-lg">
          ...
          >
            <h2 className="h4 sm:h3 lg:h2 m-2 text-center">
              What clients said:
            </h2>
            <div className="panel p-3 lg:p-6 bg-secondary dark:bg-gray-800 rounded-3 mt-3 sm:mt-6">
                ...
                <div>
                  <div className="panel">
                    ...
                    >
                      {testimonials.map((testimonial, index) => (
                        ...
                        >
                          <div className="panel vstack justify-between items-center gap-2 lg:gap-3 h-100 text-center">
                            <div className="panel">
                              <i className="icon icon-4 unicon-quotes text-black" />
                              <p className="fs-6 sm:fs-5 lg:fs-4 fw-bold mt-1 sm:mt-4 text-black">
                                {testimonial.quote}
                              </p>
                            </div>
                            <div className="panel pt-0">
                              <div className="panel vstack items-center gap-narrow">
                                ...
                                <span className="fs-6 opacity-70 text-black">
                      ...
                      <div className="panel pt-0">
                        <div className=" spb1 swiper-pagination text-black m-0 justify-center swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal" />
                      </div>
                    </Swiper>
                  </div>
                </div>
