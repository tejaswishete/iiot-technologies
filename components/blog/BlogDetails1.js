...
export default function BlogDetails1({ blogItem }) {
  return (
    <>
      ...
      <article className="post type-post single-post pt-8 lg:pt-12 xl:pt-16">
        <div className="container max-w-xl">
  ...
  <h1 className="h4 sm:h2 lg:h1 xl:display-6">
    Unlock Real-Time Visibility Across Your Factory Floor with IIOT Technologies
  </h1>                <ul className="post-share-icons nav-x gap-1 dark:text-white">
                  <li>
                    <a
