          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                 IIOT Technologies by Geany Softech Pvt. Ltd. revolutionizes industrial automation by seamlessly integrating with PLC-driven machines. It enables manufacturers to shift from reactive to proactive, data-driven decision-making. The platform provides real-time insights into machine performance, optimizing production by identifying inefficiencies, predicting issues, and streamlining maintenance. This enhances productivity and minimizes downtime, driving smarter manufacturing.              </p>
            </div>
