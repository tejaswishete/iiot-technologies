...
export default function Topbar() {
  return (
    <div
      className="uc-banner-top py-0 p-0 m-0 hide-on-sticky text-center bg-gradient-to-r from-primary dark:from-tertiary-200 to-primary-700 dark:to-tertiary text-white dark:text-dark"
      data-uc-alert=""
