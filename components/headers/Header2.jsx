...
import iiot_nav from "./component/iiot_nav";
...
export default function Header2() {
  ...
  return (
    ...
    >
      <nav
  className={`uc-navbar-container uc-navbar-float z-1 bg-[#0b2d33] ${
        ...
        <div className="container max-w-xl">
          <div className="uc-navbar min-h-64px lg:min-h-80px text-gray-900 dark:text-white">
            ...
            <div className="uc-navbar-right">
              ...
              <a
              className="btn btn-primary btn-md text-black mt-2 fw-medium"
