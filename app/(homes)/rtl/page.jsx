...
export const metadata = {
  title:
    "Rtl Home Page || IIOT - Full-featured, professional-looking software, saas and startup nextjs template.",
  description:
    "IIOT - Full-featured, professional-looking software, saas and startup nextjs template.",
};
